...
def debugCall (map,configuration,state):
    print ("---------------- Map -----------------")
    print ("-- El mapa determina las acciones validas en cada estado --")
    print ("-- Es una lista con un elemento por casilla --")
    print ("-- Cuando se accede por indices, se hace mapa[linea][columna] --")
    print ("-- Cada casilla tiene atributos especificos, dependientes del juego --")
    print (map)
    print ("---------------- Configuration ------------------")
    print ("-- Es un diccionario con informacion global, que incluye --")
    print ("-- entre otros la posicion inicial (importante)          --")
    print (configuration)
    print ("---------------- Game State -----------------")
    print ("-- El estado es informacion agregada del juego, ---")
    print ("-- hay que extraer la parte que interesa --")
    print ("-- No incluye la posicion que viene en el mapa --")
    print (state)
